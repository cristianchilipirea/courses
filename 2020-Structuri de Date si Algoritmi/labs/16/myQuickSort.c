...
void printAll(int *v, int *vQSort, int N)
{
	...
	printf("Sorted with myQuickSort:\n");
	displayVector(v, N);
	compareVectors(v, vQSort, N);
}
...
void myQsort(void *v, size_t numElements, size_t sizeOfOneElement, int (*compar)(const void *, const void *))
{
	// TODO
}
